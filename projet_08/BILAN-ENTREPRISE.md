...
**Le seuil de confiance (0.6) n'a été validé "à la main" que sur une poignée de questions.** Les résultats observés étaient cohérents (0.19 à 0.83, bien séparés), mais ce n'est pas la même chose qu'une validation systématique sur les formulations réelles des 19 fiches KB, avec des métriques de précision/rappel avant un vrai déploiement.
